...
const PayrollPage = () => {
  ...
  const { payslipData, employeeData, loading, error } = useSelector(
    (state) => state.payslip
  );
                ...
                <div id="pdf-content">
                  ...
                  <div className="p-0">
                    ...
                    <table className="w-full border-collapse border border-gray-400">
                      <tbody>
                        <tr>
                          <td className="border border-gray-400 p-3 font-semibold bg-gray-100 w-1/4">
                            Name
                          </td>
                        ...
                        <tr>
                          <td className="border border-gray-400 p-3 font-semibold bg-gray-100">
                            Date of Joining
                          </td>
                    ...
                    <table className="w-full border-collapse border border-gray-400">
                      <tbody>
                        <tr>
                          ...
                          <td className="border border-gray-400 p-3 w-1/4">
                            {payslipData?.daysInMonth || 30}
                          </td>
                          <td className="border border-gray-400 p-3 font-semibold bg-gray-100 w-1/4">
                            Salary Paid for Days
                          </td>
                          <td className="border border-gray-400 p-3 w-1/4">
                            {payslipData?.salaryPaidDays ||
                        ...
                        <tr>
                          ...
                          <td className="border border-gray-400 p-3">
                            {payslipData?.oldLeavesBalance || ""}
                          </td>
                          <td className="border border-gray-400 p-3 font-semibold bg-gray-100">
                            New Leaves Balance
                          </td>
                          <td className="border border-gray-400 p-3">
                            {payslipData?.newLeavesBalance || ""}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table className="w-full border-collapse border border-gray-400">
                      ...
                      <tbody>
                        ...
                        {Array.from({
                          ...
                          const deduction = (payslipData.deductions || [])[
                            index
                          ];
                        ...
                        <tr className="bg-gray-100 font-semibold">
                          ...
                          <td className="border border-gray-400 p-3 text-right">
                            {(payslipData?.totalEarnings || 0).toFixed(0)}
                          </td>
                          <td className="border border-gray-400 p-3 text-right">
                            {(payslipData?.totalEarnings || 0).toFixed(0)}
                          </td>
                          <td className="border border-gray-400 p-3">Total</td>
                          <td className="border border-gray-400 p-3 text-right">
                            {(payslipData?.totalDeductions || 0).toFixed(0)}
                          </td>
                        </tr>
